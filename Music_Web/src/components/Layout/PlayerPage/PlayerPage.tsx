...
import MusicListNextTrack from "./components/MusicListItem"
...
const Wrapper = styled.div<{ $isSideBarOpen: boolean }>`
    ...
    ${props => (props.$isSideBarOpen ? "left:240px;width:calc(100vw - 240px);" : "left:72px;width:calc(100vw - 72px);")}
    ${({ theme }) => theme.medium`
